      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          <h1 style={{
            ...
            color: palette.ink, fontWeight: 400, marginBottom: 6,
          }}>
            Set up your profile
          </h1>
        ...
        {saved ? (
          <div style={{ textAlign: "center", padding: "2rem 0" }}>
            ...
            <p style={{ fontFamily: font.body, fontSize: 14, color: palette.success, fontWeight: 600 }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{
                ...
                fontFamily: font.body, fontSize: 13, color: palette.muted,
